...
public class CaesarCipherDemo
{
    ...
    {
        /*
         * A Scanner object parses primitive types and Syrings from a stream.
         * 
         * A strean is a sequince of characters from a file, String, terminal
         *      network connection, etc.
         *      
         * Parsing is seperating a sequence of characters into tokens based on delimiters.
         * 
         ...
         *      3. leave a soace after the prompt
         */
        ...
        /*
         * The next methods returns the next token in the stream as a String
         */
